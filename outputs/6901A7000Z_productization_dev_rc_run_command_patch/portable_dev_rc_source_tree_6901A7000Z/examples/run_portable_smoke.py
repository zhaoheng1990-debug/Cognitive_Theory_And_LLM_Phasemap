...
def main() -> None:
    ...
    print({
        "kernel_owner": decision.kernel_owner,
        "advisory_only": advisory.advisory_only,
        "harness_no_external_effect": receipt.no_external_effect,
        "replay_verified": replay.deterministic_match,
        "production_release": replay.production_release,
        "truthfulness_rows": len(replay_truthfulness_matrix()),
    })
