# Cover Letter for a Formal Nature Article Submission
...
We believe the work is appropriate for Nature because it addresses a broad scientific problem: how to distinguish the organization of a distributed computation from observations of its individual parts. The article may be useful to researchers studying artificial intelligence, complex systems and population-level dynamics, while making no claim that these systems share a mechanism. Source data, metadata and verification code are available through the cited Zenodo concept records and the associated GitHub branch.

All authors have approved the manuscript and its submission. The manuscript is not under consideration elsewhere. No version is publicly posted as a preprint at the time of submission. The authors declare no competing interests. The use of generative-AI tools is documented in the Methods; all authors retain responsibility for the work.
