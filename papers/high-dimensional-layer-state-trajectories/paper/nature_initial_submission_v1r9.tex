...
\textsuperscript{4}Independent Researcher, Shanghai 200030, China.\\
...
Gemma new-graph confirmation & Gemma-3-12B-it QAT Q4\_0 GGUF; full model digest in Source Data run metadata & 48 / 3,840 & Same last non-padding token from each block output as above; embedding excluded. Pinned native capture source with GGUF QAT Q4\_0 loading \\
\bottomrule
\end{longtable}
\endgroup
\linenumbers
